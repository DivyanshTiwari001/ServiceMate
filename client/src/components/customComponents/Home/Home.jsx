                    ...
                    <CardContent className='p-0'>
                      <div className="w-full h-84 border-2 flex flex-col justify-start items-center rounded-2xl">
                        <div className='w-full h-1/3 rounded-t-2xl flex flex-row justify-center border-b-2 shadow-sm'>
                          <img src={item.profilePhoto} className='rounded-full' alt="" />
                        </div>
                        <div className='w-full h-2/3 flex flex-col items-center gap-y-1'>
                          <div className='w-full flex flex-col items-center'>
                            <p className='w-full text-3xl font-bold font-serif text-center'>
                              {item.username}
                            </p>
                            <table className='w-3/4 font-serif mt-0'>
                              ...
                              <tr className='w-full flex flex-row'>
                                ...
                                <td className='w-1/2 text-start text-xl'>{' : ' + item.field}</td>
                              </tr>
                              <tr className='w-full flex flex-row'>
                                <td className='w-1/4  text-start text-xl'>Address </td>
                                <td className='w-9/12  text-start text-xl'>{' : ' + (item.address).slice(0,30) + (((item.address).length>30)?' ...':'')}</td>
                              </tr>
                              <tr className='w-full flex flex-row'>
                          ...
                          <Button className='font-serif font-bold text-lg'>Book Now!</Button>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
